...
public class StockReport extends javax.swing.JFrame {
    ...
    private String sinceDate, untilDate;
            ...
            .addGroup(bgRLayout.createSequentialGroup()
                ...
                .addGroup(bgRLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(bgRLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(sinceInput, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(73, 73, 73)
                        .addComponent(untilLabel)
                        .addGap(18, 18, 18)
                        .addComponent(untilInput, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        bgRLayout.setVerticalGroup(
            ...
            .addGroup(bgRLayout.createSequentialGroup()
                ...
                .addGroup(bgRLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(sinceInput, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(untilInput, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void viewButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewButtonActionPerformed
        ...
        initStockReportTable();
    }//GEN-LAST:event_viewButtonActionPerformed

    private void initStockReportTable() {

       /* if(sinceDate.length() < 1 | untilDate.length() <1){
            JOptionPane.showMessageDialog(null, "Please insert Since Date and Until Date");
        }
        else if(!ATSReport.isValidDate(sinceDate) | !ATSReport.isValidDate(untilDate)){
            System.out.println("is valid since: "+ ATSReport.isValidDate(sinceDate));
            System.out.println("is valid since: "+ ATSReport.isValidDate(untilDate));

            JOptionPane.showMessageDialog(null, "The date format must be yyyy-mm-dd");
        }
        else
            try (Connection connection = DbConnection.getConnection()){
                ...
                statement.addBatch("create view if not exists t as \n")
                        + "select BlankStock.BlankID, BlankStock.BlankSold, BlankStock.DateReceived, \n"
                        + ""
            }*/
    }
    ...
    private void printButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_printButtonActionPerformed
        ...
        try{
            ...
            System.err.format("Error printing", e.getMessage());
        }
