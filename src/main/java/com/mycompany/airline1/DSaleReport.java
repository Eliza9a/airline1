...
public class DSaleReport extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        /* If Nimbus (introduced in Java SE 6) is not available,titleith the default look and feel.
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DSaleReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DSaleReport().setVisible(true);
            }
        });
    }
